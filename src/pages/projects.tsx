            ...
            <div className="projectPageContainer">
                ...
                <div className="projectContainer">
                    ...
                    <div className="projectLinks">
                        <a href="https://main--meowpop.netlify.app/" target="_blank">
                            <FaArrowUpRightFromSquare />
                        </a>

                        <a href="https://github.com/pauleenaphan/Meow-Pop" target="_blank">
                ...
                <div className="projectContainer">
                    ...
                    <div className="projectLinks">
                        <a href="https://main--blogwog.netlify.app/" target="_blank">
                            <FaArrowUpRightFromSquare />
                        </a>

                        <a href="https://github.com/pauleenaphan/blog-api" target="_blank">
                            <FaGithub className="githubIcon"/>
                        </a>
                    </div>
                </div>
                ...
                <div className="projectContainer">
                    ...
                    <div className="projectLinks">
                        <a href="https://cattagram.netlify.app/" target="_blank">
                            <FaArrowUpRightFromSquare />
                        </a>

                        <a href="https://github.com/pauleenaphan/Cattagram" target="_blank">
                            <FaGithub className="githubIcon"/>
                        </a>
                    </div>
                </div>
                ...
                <div className="projectContainer">
                    ...
                    <div className="projectLinks">
                        <a href="https://expo.dev/preview/update?message=fixed%20styling&updateRuntimeVersion=1.0.0&createdAt=2024-05-07T05%3A25%3A18.090Z&slug=exp&projectId=d55f227c-6164-4fc5-ac60-040c4b42bad2&group=f55c8b6c-df7a-4874-9605-f10a26a3b534" target="_blank">
                            <FaArrowUpRightFromSquare />
                        </a>

                        <a href="https://github.com/pauleenaphan/MentalMe" target="_blank">
                            <FaGithub className="githubIcon"/>
                        </a>
                    </div>
                </div>
                ...
                <div className="projectContainer">
                    ...
                    <div className="projectLinks">
                        <a href="https://pauleenaphan.github.io/weather-app/src/index.html" target="_blank">
                            <FaArrowUpRightFromSquare />
                        </a>

                        <a href="https://github.com/pauleenaphan/weather-app" target="_blank">
                            <FaGithub className="githubIcon"/>
                        </a>
                    </div>
                </div>
                ...
                <div className="projectContainer">
                    ...
                    <div className="projectLinks">
                        <a href="https://pauleenaphan.github.io/Etch-a-Sketch/" target="_blank">
                            <FaArrowUpRightFromSquare />
                        </a>

                        <a href="https://github.com/pauleenaphan/Etch-a-Sketch" target="_blank">
                            <FaGithub className="githubIcon"/>
                        </a>
                    </div>
                </div>
